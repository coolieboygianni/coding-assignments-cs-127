...
def getData():
     ...
     """
     input = ("Enter the name of the CSV file: ")
...
def getColumnNames():
     ...
     """
     file_path = input("Please enter the csv file: ")
     df = pd.read_csv(file_path)
     latName = input("Enter the name of the column that contains latitude: ")
     lonName = input("Enter tha name of the column that contains longitude: ")
...
def getLocale():
     ...
     lat = float(input("Enter the latitude of your current location: "))
     lon = float(input("Enter the longitude of your current location: "))
     return(lat, lon)
